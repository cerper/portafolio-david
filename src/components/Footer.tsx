        ...
        <div className="grid grid-cols-1">
          ...
          <div className="mt-20 flex flex-col gap-3">
            <div className="flex flex-col items-center justify-center gap-2 text-black">
              <BsFillTelephoneFill className="text-2xl text-black" />
              <h6 className="text-center text-3xl font-oswald">Contactame</h6>
              <p className="text-xl font-semibold">davidlovera16@gmail.com</p>
              <div className="flex gap-4">
                <Link
                  href="https://wa.link/u4orbj"
                ...
                <Link
                  href="https://www.instagram.com/davidlovera96/"
                  className="transition-all duration-200 ease-in hover:scale-105"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
